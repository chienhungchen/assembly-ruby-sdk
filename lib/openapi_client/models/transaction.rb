...
module OpenapiClient
  class Transaction
    ...
    def self.openapi_types
      {
        ...
        :'payee_details' => :'TransactionPayeeDetails',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'payee_details')
        self.payee_details = attributes[:'payee_details']
      end
    ...
    def hash
      [id, created_at, updated_at, description, payee_name, type, type_method, state, user_id, user_name, item_name, dynamic_descriptor, account_id, account_type, amount, currency, debit_credit, marketplace, related, payee_details, links].hash
    end
