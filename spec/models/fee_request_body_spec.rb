...
# Unit tests for OpenapiClient::FeeRequestBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::FeeRequestBody do
  let(:instance) { OpenapiClient::FeeRequestBody.new }

  describe 'test an instance of FeeRequestBody' do
    it 'should create an instance of FeeRequestBody' do
      expect(instance).to be_instance_of(OpenapiClient::FeeRequestBody)
    end
  end
