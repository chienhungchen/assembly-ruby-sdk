...
# Unit tests for OpenapiClient::TokenAuthRequestBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TokenAuthRequestBody do
  let(:instance) { OpenapiClient::TokenAuthRequestBody.new }

  describe 'test an instance of TokenAuthRequestBody' do
    it 'should create an instance of TokenAuthRequestBody' do
      expect(instance).to be_instance_of(OpenapiClient::TokenAuthRequestBody)
    end
  end
