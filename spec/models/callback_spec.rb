...
# Unit tests for OpenapiClient::Callback
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Callback do
  let(:instance) { OpenapiClient::Callback.new }

  describe 'test an instance of Callback' do
    it 'should create an instance of Callback' do
      expect(instance).to be_instance_of(OpenapiClient::Callback)
    end
  end
